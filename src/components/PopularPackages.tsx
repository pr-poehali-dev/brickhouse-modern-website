...
const packages = [
  {
    ...
    highlights: ["Париж", "Рим", "Барселона", "Вена"],
    price: "89 900 ₽",
  },
  {
    title: "Азия вглубь",
    ...
    highlights: ["Бангкок", "Чиангмай", "Бали", "Сингапур"],
    price: "74 900 ₽",
  },
  {
    ...
    highlights: ["Серенгети", "Масаи Мара", "Килиманджаро", "Занзибар"],
    price: "129 900 ₽",
  },
]
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="max-w-3xl mb-20">
          <h2 className="text-5xl md:text-6xl font-light tracking-tight mb-6 text-balance">
            Популярные <span className="font-semibold">экскурсионные туры</span>
          </h2>
          <p className="text-lg text-muted-foreground text-balance leading-relaxed">
            Готовые программы с гидом, трансфером и проживанием — просто выбери и отправляйся
          </p>
        </div>
